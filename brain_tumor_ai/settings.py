"""
Django settings for brain_tumor_ai project.
...
# IMPORTANT: Set TensorFlow environment variables BEFORE any imports
...
ROOT_URLCONF = 'brain_tumor_ai.urls'
...
WSGI_APPLICATION = 'brain_tumor_ai.wsgi.application'
